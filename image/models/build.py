...
from .swin_transformer_emel import SwinTransformerEmeL
...
def build_model(config, is_pretrain=False):
    ...
    if is_pretrain:
        ...
        return model
    if model_type == 'swin':
        if config.MODEL.EMEL:
            model = SwinTransformerEmeL(img_size=config.DATA.IMG_SIZE,
                                        ...
                                        emel_t=config.MODEL.EMEL_T,
                                        emel_f=config.MODEL.EMEL_F)
        else:
