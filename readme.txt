...
For the tasks "language", "image", and "physics", please check the corresponding directories.

All the random keys are fixed and provided. Running under the same setting can exactly reproduce our results.
